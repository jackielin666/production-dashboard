---
name: monthly-report
description: 產生「生產業務月報」——依 data/latest.xlsx 分析指定月份的業務量（鍋數／重量）、接單下滑警示、斷單、成長品項與季節性，輸出 HTML 報告到 reports/ 並推上 GitHub Pages 取得可分享連結。當使用者說「幫我分析 2026年8月」「幫我出 8 月月報」「分析上個月」「月度分析」「月報」時使用。
---
